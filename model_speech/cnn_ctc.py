...
class Am():
    ...
    def _model_init(self):
        ...
        self.h8 = bi_gru(256, self.h7)
        self.h9 = bi_gru(256, self.h8)
        self.h10 = Dropout(0.2)(self.h9)
        self.outputs = dense(self.vocab_size, activation='softmax')(self.h10)
...
def bi_gru(units, x):
    ...
    y2 = GRU(units, return_sequences=True, go_backwards=True,
        kernel_initializer='he_normal')(x)  #双向GRU
    y = add([y1, y2])
    return y